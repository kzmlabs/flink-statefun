...
#
VERSION_TAG=3.4.0-KZM-1.0-SNAPSHOT
...
#
distribution_jar=$(find ${project_root} -type f -name "statefun-flink-distribution*-shaded.jar" -not -name "*example*" -not -name "*sources*" -not -name "*javadoc*")
